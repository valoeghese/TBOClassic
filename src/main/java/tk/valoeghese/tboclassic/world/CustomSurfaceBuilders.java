package tk.valoeghese.tboclassic.world;
...
import tk.valoeghese.tboclassic.util.noise.OpenSimplexNoise;
...
public class CustomSurfaceBuilders
{
	...
	public static void registerBuilders()
	{
		...
		TBOClassic.getLogger().debug("Registered Surface Builders!");
	}
