...
public class WoodedMountainPeaksBiome extends TBOBiome
{
	...
	{
		super(BiomeFactory.create(2.65F, 0.35F, Biome.Category.EXTREME_HILLS).setSurfaceBuilder(SurfaceBuilder.MOUNTAIN).setTemperatureDownfall(0.2F, 0.4F).setSpawnChance(0.04F));
