...
public class MurkyBayouBiome extends TBOBiome
{
	...
	{
		super(BiomeFactory.create(-0.14F, 0.1F, Biome.Category.SWAMP).setTemperatureDownfall(0.9F, 0.75F).setWaterProperties(0x2c9943, 0x28b747).setCustomSkyColour(0x7fdbd0).setRiverType(RiverType.NONE));
